...
export default class Thriller extends React.Component {
  constructor() {
    super();
    this.state = {
      show: false,
  ...
  fetchData = (page) => {
    ...
    axios.get(requests.fetchthriller + `&page=${page}`).then((data) =>
      this.setState({
  ...
  render() {
    return (
      <div className="thriller">
        ...
        <div className="thriller__button">
          <button
        ...
        <div className="thriller__movies">
